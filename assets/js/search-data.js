    ...
    handler: () => {
      window.location.href = "/";
          ...
          handler: () => {
            ...
            },{id: "dropdown-director-of-wellness",
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-new-paper-accepted-by-computer-aided-civil-and-infrastructure-engineering-cacaie",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%61%6F%31%33@%75%61%6C%62%65%72%74%61.%63%61", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/LMChina", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/mao-li-1522b5292", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=EdCSCzYAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/Mao-Li-20/", "_blank");
        },
      },{
      id: 'light-theme',
