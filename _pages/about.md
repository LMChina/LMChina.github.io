...
title: About
permalink: /
subtitle: '<strong>Actively seeking faculty position opportunities in structural and earthquake engineering.</strong><br>Email: <a href="mailto:mao13@ualberta.ca">mao13@ualberta.ca</a>'
...
profile:
  ...
  more_info: >
    <p>Innovation. Reliability. Resilience.</p>
...
- **Probabilistic Performance-Based Seismic Design (PBSD):** Developing comprehensive frameworks for evaluating the seismic vulnerability and resilience of building structures under earthquake loading.
- **AI for Structural Engineering:** Developing machine learning and deep learning surrogate models, such as Physics-Informed Neural Networks, to significantly accelerate nonlinear time-history analysis, enhance overall seismic risk assessment, and directly facilitate PBSD frameworks.
- **Smart Structural Control & Damping Systems:** Designing and testing advanced adaptive systems, including variable damping devices, variable damping and stiffness devices, and inerter-based dampers with variable inertance.
